''' Deprecated. Not using this script because it's synchronous and blocking. 
	For scalability, the architecture has been adapted to an asynchronous one, using Tornado Web Framework.
	Refer to spider/scraper.py for the async code.
'''
...
class Crawler(object):
	...
	def _send_request(self):
		try:
			r = requests.get(self.url, timeout=Crawler.REQUEST_TIMEOUT) # BLOCKING NETWORK IO
			r.raise_for_status()
			return r
